    ...
    <body>
        <div class='row me-2 me-md-5'>
            ...
            <div class="container text-center col-10 col-sm-9 col-xxl-9 col-md-9 mt-2 me-md-0 ">
                            <h1 class="p-3 bg-dark text-white rounded">Gerenciar resultados</h1>
                            <form action="{{ route('resultados.buscar') }}" method="get">
                                <div class="d-flex justify-content-end mb-3">
                                    <select class="form-select me-2" id="selectProjetos" name="id_projeto" required>
                                        <option value="">Selecione um projeto para gerenciar os resultados</option>
                            ...
                            <div class="d-flex justify-content-end mb-3 p-2">
                                <a  href="#addEmployeeModal" class="btn btn-dark my-1 me-2 text-white rounded" data-toggle="modal">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span>Adicionar novo resultado</span>
                                    </div>
                                </a>
                            </div>
                            <table class="table table-striped table-bordered" id="projectTable">
                                    ...
                                    @foreach($resultados as $resultado)
                                        <tr class="text-center">
                                            ...
                                            <td scope="col" class="text-center">
                                                ...
                                                <a href="#editEmployeeModal" class="edit" id="editar" data-toggle="modal" data-id="{{ $resultado->id }}">
                                                    <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
                                                </a>
                                                <a href="#deleteEmployeeModal" class="delete" data-toggle="modal" data-id="{{ $resultado->id }}">
                                ...
                                @else
                                    <tr>
                                        <td colspan="5" class="text-center">Nenhum resultado disponível, selecione um projeto para fazer a busca.</td>
                                    </tr>
                                @endif
                                </tbody>
                            </table>
            ...
            @include('components.modaisResultados')
        </div>
