    ...
    <div class='row me-2 me-md-5'>
        ...
        <div class="container text-center col-10 col-sm-9 col-xxl-9 col-md-9 mt-2 me-md-0 ">
            ...
            <div class="d-flex justify-content-end mb-3 p-2">
                ...
                @endphp
                <a href="{{ $currentUrl == route('itens') ? 'javascript:void(0)' : '#addEmployeeModal' }}" class="btn btn-dark my-1 me-2 text-white rounded" data-toggle="modal" id="abrirModalBtn">
                    <div class="d-flex align-items-center">
                        <i class="material-icons me-1">&#xE147;</i>
                        <span>Adicionar novo item</span>
                    </div>
                </a>
                @if ($currentUrl == route('itens'))
                    <div id="mensagemError" class="alert alert-danger text-center my-2" style="display: none;">
                        <span>Selecione um projeto para gerenciar os itens!</span>
                    </div>
                @endif
            </div>
